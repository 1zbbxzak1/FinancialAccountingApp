...
export class UserMapper {
    ...
    public UserModelToIUserRequestModel(user: UserModel): IUserRequestModel {
        return {
            name: user.name,
    ...
    public ParamsToIUserRequestModel(email: string, notification: boolean, name: string | null = null, surname: string | null = null,
